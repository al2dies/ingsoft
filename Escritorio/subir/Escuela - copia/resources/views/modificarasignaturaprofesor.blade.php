    ...
    <div class="container">
      ...
      <div class="blog-header">
       <center> <h1 class="blog-title"><font face="gabriola" color="#FD4141">Modificar Asignatura a  Profesor </font></h1>
         <h2 class="blog-title"><font face="gabriola" color="#FD4141">Por favor Ingrese el Nit del profesor y el codigo de la Asignatura</font></h2></br></center>
<table width="20" height="70" border="0" align="center" >
  <td><td><td><center>
  <form id="form1" name="form1" method="get" action="{!!route('buscarcodregpro')!!}" >
