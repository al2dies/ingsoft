...
<form id="form1" name="form1" method="post" action="{!!route('guardarprofesor')!!}">
  <table width="40%" height="200" border="0" align="center" cellpadding="11" cellspacing="11">
    ...
    <center><button type="submit" style="background:#891B1B; width:200px; height:40px" name="submit" ><font size="5"color="white" face="gabriola">Agregar</font></button></a>
          ...
          <center><a href ="{!! route('actualizacionpro')!!}"> <button type="submit" style="background:#891B1B; width:200px; height:40px" name="submit" ><font size="5"color="white" face="gabriola">Actualizar</font></button></a>
           <a href ="{!!route('registroexpro')!!}"> <button type="submit" style="background:#891B1B; width:280px; height:40px" name="submit" ><font size="5"color="white" face="gabriola">Cambiar a modo Ex-Docente</font></button></a><BR></center>
