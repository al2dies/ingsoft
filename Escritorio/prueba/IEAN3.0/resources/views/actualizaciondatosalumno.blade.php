...
<br></br>
  ...
  <table  width="40%" height="100" border="0" align="center" cellpadding="11" cellspacing="11">
    ...
    <td>
<center> <button type="submit" style="background:#FD4141; width:100px; height:35px" name="submit" ><font size="5"color="black" face="verdana">Buscar</font></button></a></center>
    </td>
    <td width="400"><label>
