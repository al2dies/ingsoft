<?php
  ...
  return $conex;
   ...
   $sql = "SELECT * FROM exprofesores WHERE nit = '$cod'";
...
<br></br>
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title"><font face="gabriola" color="#FD4141">~ Actualizacion de datos ~ Ex-Profesores ~</font></h1>
         ...
         <form id="form1" name="form1" method="get" action="{!!route('modificacionexpro')!!}" >
  ...
  <table width="40%" height="100" border="0" align="center" cellpadding="7" cellspacing="7">
   ...
   <td width="200"><label>
    ...
    <td>
   <center><button type="submit" style="background:#FD4141; width:90px; height:35px" name="submit" ><font size="5"color="black" face="gabriola">Actualizar</font></button></td>
