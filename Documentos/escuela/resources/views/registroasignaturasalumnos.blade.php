...
<center>
          ...
          <a href ="{!!route('modificarasigal')!!}"> <button type="submit" style="background:#FD4141; width:200px; height:40px" name="submit" ><font size="5"color="black" face="gabriola">Modificar</font></button></a></center><br>           
